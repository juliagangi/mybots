...
class SOLUTION:
    def __init__(self,nextAvailableID,parentID):
    ...
    def Start_Simulation(self,directOrGUI,parentOrChild):
        self.Create_World()
        self.Create_Body(parentOrChild)
        self.Create_Brain()
        #os.system("python3 simulate.py " + directOrGUI + " " + str(self.myID) + " 2&>1 &")
        os.system("python3 simulate.py " + directOrGUI + " " + str(self.myID) + " " + str(self.parentID) + " &")
    ...
    def Create_Body(self,parentOrChild):
        if parentOrChild == 'child':
            pass
        else:
            print("creating body")
            pyrosim.Start_URDF("body" + str(self.parentID) + ".urdf")
            numsensorneurons = 0
            height = c.height
            length = c.length
            print("height")
    ...
    def Create_Brain(self):
        ...
        for joint in self.joints:
            ...
            i = i + 1
        print("num sensor neurons")
        print(c.numSensorNeurons)
        print("sensor neuron array")
        print(c.sensorNeuronsArray)
        print("num motor neurons")
